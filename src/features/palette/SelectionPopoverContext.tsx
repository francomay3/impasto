...
function SelectionGroupDialog({ pos, close }: { pos: PopoverPos; close: () => void }) {
  const { selectedColorIds, onSelectColor, hiddenPinIds, onSetGroupPinsVisible } = useEditorContext();
