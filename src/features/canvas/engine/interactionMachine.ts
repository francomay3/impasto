...
export function deriveToolState(ctx: InteractionContext, stateValue: string): ToolState {
  return {
    activeTool:
    ...
    samplingColorId: ctx.samplingColorId,
    samplingLevels: ctx.samplingLevels,
    samplingRadius: ctx.samplingRadius,
  };
}
