      ...
      <Group gap={6} wrap="nowrap" align="center">
        ...
        <Tooltip label={`Sample ${label} from image`} transitionProps={{ duration: 0 }}>
          <ActionIcon
            ...
            aria-label={`Sample ${label} from image`}
            onClick={onSample}
          >
            <Pipette size={10} />
          </ActionIcon>
