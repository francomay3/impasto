/**
 * Primary / middle-button pan drag for a viewport canvas.
 * Wheel/pinch zoom is handled at the React layer via use-gesture (see ViewportWrapper.tsx).
 *
...
import { nextViewportTransformAfterPanMove } from './viewportCanvasGestures';
...
/** Owns `panDrag` state for one canvas. */
